...
void preClusteringChain()
{
  ...
  pHLT->LoadComponentLibraries("libdhlt");
  ...
  AliHLTConfiguration digitLoader("digitLoader","MUONDigitLoader",sources.Data()," -cdbpath $ALIHLT_HCDBDIR");

  AliHLTConfiguration preClustering("preClustering","MUONPreclusterFinder","digitLoader"," -binmapfile binmapfile.dat");
