...
class AliMUONClusterFinderMLEMdebug : public AliMUONVClusterFinder
{
public:
  AliMUONClusterFinderMLEMdebug(Bool_t plot, AliMUONVClusterFinder* clusterFinder); // Constructor
  virtual ~AliMUONClusterFinderMLEMdebug(); // Destructor
...
private:
  /// Not implemented
  AliMUONClusterFinderMLEMdebug(const AliMUONClusterFinderMLEMdebug& rhs);
  /// Not implemented
...
public:
  ...
  AliMUONClusterSplitterMLEMdebug* fSplitter; //!<! helper class to go from pixel arrays to clusters
