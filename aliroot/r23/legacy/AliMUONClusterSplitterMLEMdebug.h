...
class AliMUONClusterSplitterMLEMdebug : public TObject
{
public:
  AliMUONClusterSplitterMLEMdebug(Int_t detElemId, TObjArray* pixArray, 
                             Double_t lowestPixelCharge,
                             Double_t lowestPadCharge,
                             Double_t lowestClusterCharge);
  
  virtual ~AliMUONClusterSplitterMLEMdebug();
...
private:
  ...
  AliMUONClusterSplitterMLEMdebug(const AliMUONClusterSplitterMLEMdebug&);
  /// will not be implemented
  AliMUONClusterSplitterMLEMdebug& operator=(const AliMUONClusterSplitterMLEMdebug&);
